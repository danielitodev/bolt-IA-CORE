...
export default function SettingsModal() {
  ...
  return (
    <div className="relative flex justify-end p-4"> {/* Ajuste de posición */}
      {/* Contenedor del avatar con mejor posicionamiento */}
      <div>
        <img
          src={user.avatar}
          alt="User avatar"
        ...
        {isProfileOpen && (
          ...
          >
            <motion.div 
              ...
              className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-sm w-full mx-4 shadow-lg relative"
